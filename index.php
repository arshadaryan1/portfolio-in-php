            ...
            <div class="layer layer1 active">
                <div class="home main">
                    ...
                    <div class="content-for-home">
                        ...
                        <h1 align="center">MR. ARSHAD ALI</h1>
                        <div class="social-icons">
                            <div class="s-icon">
                                <a href="https://www.facebook.com/iit.arshad">
                                    <i class="fab fa-facebook"></i>
                                </a>
                                <div class="s-name">Facebook</div>
                            </div>
                            <div class="s-icon">
                                <a href="https://www.twitter.com/arshad_aryan">
                            ...
                            <div class="s-icon">
                                <a href="https://www.instagram.com/arshad__aryan">
                                    <i class="fab fa-instagram"></i>
                                </a>
                                <div class="s-name">Instagram</div>
                            </div>
                            <div class="s-icon">
                                <a href="mailto:admin@arshadaryan.xyz">
                    ...
                    <div class="about_container">
                        ...
                        <div class="experience">
                            ...
                            <div class="cover">
                                ...
                                <i class="date">Aug 2022 - Present</i>
                                <h2>Full Stack Developer</h2>
                                <i class="name_company">MCREST Pvt. Ltd.</i>
                            ...
                            <div class="cover">
                                <i class="job_box fas fa-briefcase"></i>
                                <i class="date">Apr 2022 - July 2022</i>
                                <h2>Full Stack Developer</h2>
                                <i class="name_company">ABC Company</i>
                                <article class="text_hidden">
                                    Lorem ipsum dolor sit amet consectetur
                                    adipisicing elit. Ut sint magnam ipsam
                                    eveniet omnis nemo commodi dolorum neque
                            ...
                            <div class="cover">
                                <i class="job_box fas fa-briefcase"></i>
                                <i class="date">Feb 2022 - Apr 2022</i>
                                <h2>Full Stack Developer</h2>
                                <i class="name_company">BCD Company</i>
                                <article class="text_hidden">
                                    Lorem ipsum dolor sit amet consectetur
                                    adipisicing elit. Ut sint magnam ipsam
                                    eveniet omnis nemo commodi dolorum neque
                            ...
                            <div class="cover">
                                <i class="job_box fas fa-briefcase"></i>
                                <i class="date">Jan 2022 - Feb 2022</i>
                                <h2>Full Stack Developer</h2>
                        ...
                        <div class="education">
                            ...
                            <div class="cover">
                                ...
                                <i class="date">2025 - 2027</i>
                                <h2>Masters In Science</h2>
                                <i class="name_company">Unknown College</i>
                                <article class="text_hidden">
                                    Lorem ipsum dolor sit amet consectetur
                                    adipisicing elit. Ut sint magnam ipsam
                                    eveniet omnis nemo commodi dolorum neque
                            ...
                            <div class="cover">
                                <i class="job_box fas fa-book-open"></i>
                                <i class="date">2021 - 2025</i>
                                <h2>Bachelor In Technology</h2>
                                <i class="name_company">RITS, Bhopal</i>
                                <article class="text_hidden">
                                    Lorem ipsum dolor sit amet consectetur
                                    adipisicing elit. Ut sint magnam ipsam
                                    eveniet omnis nemo commodi dolorum neque
            ...
            <div class="layer layer3">
                <div class="services main">
                    ...
                    <div class="hero">
                        ...
                        <p class="hero-text">
                            Arshad is an excellent web designer and faultless
                    ...
                    <div class="capabilities right">
                        <p class="c_content">
                            ...
                            With a designers eye for details, Arshad is
                    ...
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                ...
                                <p>
                                    <span>&ldquo;</span>
                                    Arshad is an excellent web designer and
                ...
                <div class="contact_us">
                    ...
                    <address class="info_container">
                        <div class="info info1">
                            ...
                            <a href="tel:+917581000180">+91- 7581000180</a>
                            <a href="tel:+918507019273">+91- 8507019273</a>
                        </div>
                        <div class="info info2">
                            <i class="fas fa-home"></i>
                            <span class="iname">Address</span>
                            <a
                                href="https://goo.gl/maps/a9cKfNLPVHfWbPFM6"
                            >
                                <h3>Peace Apartment</h3>
                                <span>Ashoka Garden, Bhopal</span><br />
                                <span>MP, India</span>
                            </a>
                        </div>
                        <div class="info info3">
                            ...
                            <a href="mailto:email1.gmail.com"
                                >iit.arshad@gmail.com</a
                            >
                            <a href="mailto:email2.gmail.com"
                                >iit.arshad@outlook.in</a
                            >
                        </div>
                    </address>
